...
{
    public class DevicePane: ViewModelBase
    {
        ...
        private string _header = "Device Collections";
        ...
        private string _findlabeltext = "Device:";
        ...
        public DevicePane(SccmConnector connector)
        {
